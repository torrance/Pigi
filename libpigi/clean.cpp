...
template std::tuple<HostArray<StokesI<float>, 2>, size_t> major(
    HostArray<StokesI<float>, 2>& img,
    const GridSpec imgGridspec,
    const HostArray<StokesI<float>, 2>& psf,
    const GridSpec psfGridspec,
    const Config config
);

template std::tuple<HostArray<StokesI<double>, 2>, size_t> major(
    HostArray<StokesI<double>, 2>& img,
    const GridSpec imgGridspec,
    const HostArray<StokesI<double>, 2>& psf,
    const GridSpec psfGridspec,
    const Config config
);
...
template void convolve(
    HostArray<StokesI<float>, 2>& img,
    const HostArray<std::complex<float>, 2>& kernel
);

template void convolve(
    HostArray<StokesI<double>, 2>& img,
    const HostArray<std::complex<double>, 2>& kernel
);
